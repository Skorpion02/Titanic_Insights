...
# =============================================================================
# Ordena el DataFrame del Titanic por la columna 'Age' de forma
# ascendente.
# =============================================================================
...
# =============================================================================
# Ordena el DataFrame del Titanic por las columnas 'Pclass' y 'Age' de
# forma ascendente.
# =============================================================================
...
# =============================================================================
# Crea una nueva columna llamada 'Adult' que sea True si la edad es
...
# =============================================================================
# Crea una nueva columna llamada 'Family_size' que sea la suma de las
...
# =============================================================================
# Filtra el DataFrame para mostrar solo las filas donde 'Fare' esté entre
# 50 y 100, inclusive.
# =============================================================================
...
# =============================================================================
# Crea una nueva columna llamada 'Class_high' que sea True si 'Pclass'
...
# =============================================================================
# Filtra el DataFrame para mostrar solo las filas donde 'Embarked' sea 'C'
# o 'Q'. (Usando ISIN)
# =============================================================================

data_filtrado = data[data['Embarked'].isin(['C', 'Q'])]

# =============================================================================
# Rellena los valores faltantes en la columna 'Age' con la media de esa
# columna.
# =============================================================================
...
# =============================================================================
# Crea una nueva columna llamada 'Has_Cabin' que sea True si 'Cabin'
...
# =============================================================================
# Ordena el DataFrame del Titanic por 'Fare' de forma descendente.
# =============================================================================

data_desc = data.sort_values("Fare", ascending=False)

# =============================================================================
# Crea una nueva columna llamada 'Is_Alone' que sea True si
...
# =============================================================================
# Filtra el DataFrame para mostrar solo las filas donde 'Age' esté
...
# =============================================================================
# Crea una nueva columna llamada 'Fare_Category' que sea 'High' si
...
# =============================================================================
# Rellena los valores faltantes en la columna 'Embarked' con el valor
# más frecuente.
# =============================================================================
...
# =============================================================================
# Crea una nueva columna llamada 'Age_Group' que sea 'Child' si 'Age'
...
# =============================================================================
# Ordena el DataFrame del Titanic por las columnas 'Pclass' de forma
...
# =============================================================================
# Crea una nueva columna llamada 'Is_Female' que sea True si 'Sex' es
...
# =============================================================================
# Filtra el DataFrame para mostrar solo las filas donde 'Embarked' no
# sea 'S’.
# =============================================================================
...
# =============================================================================
# Rellena los valores faltantes en la columna 'Cabin' con 'Unknown’.
# =============================================================================

data19 = data['Cabin'] = data['Cabin'].fillna('Unknown').reset_index()

# =============================================================================
# Crea una nueva columna llamada 'Has_SibSp' que sea True si 'SibSp' es
...
# =============================================================================
# Filtra el DataFrame para mostrar solo las filas donde 'Age' no esté
...
# =============================================================================
# Crea una nueva columna llamada 'Fare_Normalized' que sea el
...
# =============================================================================
# Rellena los valores faltantes en la columna 'Embarked' con el valor 'C'
